...
from courses.models import Course, Lesson, Question, Answer
...
class LessonFinishedView(DetailView):
	...
	def get(self, request, * args, ** kwargs):
		...
		if get_question_of_lesson(request.user, lesson):
			return HttpResponseRedirect(reverse_lazy('courses:answer_question', kwargs={'course_slug': self.get_course().slug, 'lesson_slug': lesson.slug}))
